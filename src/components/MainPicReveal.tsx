		...
		>
			...
			{!conceito ? (
				<motion.h1
					...
					className="md:hidden  font-goudyOldStyle w-fit sm:text-3xl text-2xl leading-5 px-4 py-8 text-zinc-800"
				>
				...
				<>
					...
					>
						...
						<br />
						{"  "} Queremos o perene, não o perecível. Buscamos elo com o que não se dilui como pó – mas ao
						que resiste feito pedra. A modernidade, para nós, é um meio, não o final abstrato. A inovação está
