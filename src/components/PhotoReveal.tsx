	...
	return (
		<div className={`image-container relative block w-full max-h-[600px] mx-auto overflow-hidden sm:w-[90%]`}>
			...
			<motion.div
				...
				className="font-goudyOldStyle w-fit  md:absolute  top-2/4 md:!-translate-y-1/2 sm:text-3xl text-xl  md:text-white text-gray-700 flex flex-col gap-5 sm:px-[13.5%] py-8 px-9 "
			>
				<h3>{topic} </h3>
