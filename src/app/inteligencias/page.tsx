...
export default function page({}: Props) {
	return (
		<div className="-mb-8">
			<h1 className="md:text-start text-center sm:gap-5 md:pl-[10%] lg:pl-[15%]  w-full px-9 pb-10 font-goudyOldStyle sm:text-3xl md:text-4xl text-xl text-gray-800 opacity-90">
